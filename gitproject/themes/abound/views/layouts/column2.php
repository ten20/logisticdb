  ...
  <div class="row-fluid">
	<div class="span2">
		<div class="sidebar-nav">
		  ...
		  <?php $this->widget('zii.widgets.CMenu', array(
			...
			'encodeLabel'=>false,
			'items'=>array(
				//array('label'=>'<i class="icon icon-home"></i>  หน้าหลัก <span class="label label-info pull-right">BETA</span>', 'url'=>array('/site/index'),'itemOptions'=>array('class'=>'')),
				...
				array('label'=>'<i class="icon icon-edit "></i>OPERATIONS','items'=>$this->menu),
			),
			));?>
		</div>
    <!--
    ...
    <?php if(isset($this->breadcrumbs)):?>
		<?php $this->widget('zii.widgets.CBreadcrumbs', array(
			...
			'homeLink'=>CHtml::link('หน้าหลัก','../site/index'),
