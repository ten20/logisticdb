...
<html lang="en">
  <head>
    ...
    <meta name="description" content="arrest,ncc,rtn,royal thai navy">
    <meta name="author" content="rattana">
    ...
    <link rel="shortcut icon" href="<?php echo $baseUrl;?>/img/icons/favicon.ico" type="image/x-icon">
    <link rel="icon" href="<?php echo $baseUrl;?>/img/icons/favicon.ico" type="image/x-icon">
   ...
   //   $cs->registerCssFile($baseUrl.'/css/style-blue.css');
      ...
      <!-- styles for style switcher -->
        ...
        <link rel=" stylesheet" type="text/css" media="screen" title="style3" href="<?php echo $baseUrl;?>/css/style-green.css" />
    ...
    $cs->registerScriptFile($baseUrl.'/js/bar.js');
