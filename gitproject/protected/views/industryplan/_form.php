<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php //echo $form->textFieldRow($model,'industrydid',array('class'=>'span5')); ?>

	<?php if(isset($model->id)){
			//$model->cologisticname=$model->cologistich->title;
			$id=$model->industrydid;
		}else{
			 $model->industrydid=$id; //create
		}
		//echo $id;
		?>
		<?php //echo $form->labelEx($model,'industrydid'); ?>
		<?php echo $form->hiddenField($model,'industrydid'); ?>
		<?php //echo $form->error($model,'industrydid'); ?>		
