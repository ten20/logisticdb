...
class IndustryplanController extends Controller
{
	/**
	...
	{
		$model=new Industryplan;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Industryplan']))
		{
			$model->attributes=$_POST['Industryplan'];
            ...
            $name_filenew = $model->industrydid.'-'.date('Y-m-d-h-i-s', time());  
			...
			if($model->save()){
				$this->redirect(array('adminshow','id'=>$model->industrydid));
			}
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Industryplan');
	...
	{
		$model=new Industryplan('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Industryplan']))
			$model->attributes=$_GET['Industryplan'];
	...
	{
		$model=Industryplan::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='industryplan-form')
		{
